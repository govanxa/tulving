...
**Status: v0.1 feature-complete — in pre-release verification.** Installable from source
today; the name-holding PyPI release is `0.0.1` while `v0.1.0` goes through final testing.
